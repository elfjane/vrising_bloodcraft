...
internal static class ConfigService
{
    ...
    /// </summary>
    public static int MaxActiveFamiliars => _maxActiveFamiliars.Value;
    ...
    static readonly Lazy<bool> _dividePlayerXpByActiveFamiliars = new(() => GetConfigValue<bool>("DividePlayerExperienceByActiveFamiliars"));
    /// <summary>
    /// If true, a player's experience gains from kills will be divided by the number of summoned familiars when the summoned count exceeds the configured threshold.
    /// </summary>
    public static bool DividePlayerExperienceByActiveFamiliars => _dividePlayerXpByActiveFamiliars.Value;

    static readonly Lazy<int> _dividePlayerXpByActiveFamiliarsThreshold = new(() => GetConfigValue<int>("DividePlayerExperienceByActiveFamiliarsThreshold"));
    /// <summary>
    /// The threshold (exclusive) of active familiars above which player's experience will be divided among active familiars. Default 2 (divide when > 2 familiars).
    /// </summary>
    public static int DividePlayerExperienceByActiveFamiliarsThreshold => _dividePlayerXpByActiveFamiliarsThreshold.Value;
    ...
    static readonly Lazy<bool> _divideFamiliarXpByActiveFamiliars = new(() => GetConfigValue<bool>("DivideFamiliarExperienceByActiveFamiliars"));
    /// <summary>
    /// If true, experience gained for familiars from a kill will be divided evenly among all active familiars (legacy behaviour: false).
    /// </summary>
    public static bool DivideFamiliarExperienceByActiveFamiliars => _divideFamiliarXpByActiveFamiliars.Value;
    ...
    public static class ConfigInitialization
    {
        ...
        [
            ...
            new ConfigEntryDefinition("Familiars", "MaxActiveFamiliars", 1, "Maximum number of familiars a player may have active simultaneously. Default 1 (legacy behavior)."),
            ...
            new ConfigEntryDefinition("Familiars", "DivideFamiliarExperienceByActiveFamiliars", false, "If true, familiar experience from a kill will be divided evenly among active familiars (each familiar receives XP/activeCount). Default false to preserve legacy behaviour."),
